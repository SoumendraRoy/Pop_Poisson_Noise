...
- in parametric model, the functional form of the population of mass, spin and redshift may change or the prior on the hyperparameters may be updated,
- in 'non-parametric' approaches, choices such as bin sizes, Gaussian process kernels, or hyperpriors (or hyperhyper prior) may be updated.
